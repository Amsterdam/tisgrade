...
class SignParameters:
    ...
    sign_regex: str         # regex for the sign examples: '^NL:C21' '^NL:A01-30.*', '^NL:[ABCD].*', '^NL:(?![A-I]).*'
...
class RunParameters:
    ...
    run_start_date_time: str    # start of period to look for the objects
    run_end_date_time: str      # end of period to look for the objects
